...
const allGameIcon = document.querySelectorAll(".fa-regular");
...
// selected styling and computerChoice
...
//check results, increase score and update results
...
function select(playerChoice) {
  ...
  //Add 'selected' styling & player choince
  switch (playerChoice) {
    case "rock":
